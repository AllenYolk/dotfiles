...
| Neovim | Neovim >= 0.11、Git、网络、C 编译器、Tree-sitter CLI、`curl`、`tar`、`rg`、`fd`、`fzf`、uv、Ruff、basedpyright、marksman | Rust/Cargo、Nerd Font、WakaTime、OpenCode Go 凭据、Linux 剪贴板 provider | [Neovim](neovim.md) |
